...
/* harmony import */ var _utils_resources__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/resources */ "./source/js/utils/resources.js");
    ...
    this.screenElements[this.activeScreen]
      ...
      .forEach((img) => {
        if (img.dataset.src !== ``) {
          ...
          Object(_utils_resources__WEBPACK_IMPORTED_MODULE_1__["imageLoaded"])(svgUrl).then(() => {
...
/*!************************************************!*\
  !*** ./source/js/modules/letters-animation.js ***!
  \************************************************/
/*! exports provided: createAnimation */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
 ...
 */
function createAnimation(node, params = {}) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _utils_animation__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/animation */ "./source/js/utils/animation.js");
...
function animateCounter(node, values, delay, duration) {
  ...
  setTimeout(() => {
    Object(_utils_animation__WEBPACK_IMPORTED_MODULE_0__["animateDuration"])(
        limitFPS(() => {
          if (i < values.length) {
            node.textContent = values[i++];
          }
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  ...
  document.body.addEventListener(`screenChanged`, ({detail}) => {
    if (detail.screenName === `game`) {
      ...
      timer = Object(_utils_animation__WEBPACK_IMPORTED_MODULE_0__["animateDuration"])((elapsed) => {
...
/* harmony import */ var _modules_timer_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/timer.js */ "./source/js/modules/timer.js");
...
Object(_modules_timer_js__WEBPACK_IMPORTED_MODULE_8__["default"])();
...
nodes.forEach((node) => Object(_modules_letters_animation_js__WEBPACK_IMPORTED_MODULE_11__["createAnimation"])(node, {
...
/***/ "./source/js/utils/resources.js":
/*!**************************************!*\
  !*** ./source/js/utils/resources.js ***!
  \**************************************/
/*! exports provided: imageLoaded */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "imageLoaded", function() { return imageLoaded; });
